...
from p1_decoder.reader import telegram_to_dict, parse_timestamp, extract_values
...
def gas_filter(telegram_dict: dict, last_gas_reading: str | None) -> tuple[dict | None, str | None]:
    """
